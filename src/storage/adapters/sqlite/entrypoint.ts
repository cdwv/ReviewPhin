...
const sqliteProviderEnvSchema = z.object({
  SQLITE_DATABASE_PATH: z.string().min(1).default("./data/review-worker.sqlite")
});

export function createStorageProvider(context: StorageProviderFactoryContext): SqliteStorageProvider {

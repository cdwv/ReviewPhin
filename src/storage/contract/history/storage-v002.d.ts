...
export type StorageTenantInput = Pick<
  TenantRecord,
  "key" | "platform" | "platformConnectionId" | "platformConfigJson"
> & {
  modelProfileName?: string | null;
};

export type PlatformConnectionStatus = "setup_required" | "ready";
...
export type PlatformConnectionQueryField =
  | "id"
  | "name"
  | "platform"
  | "status"
...
export type PlatformConnectionFilters = StoreFilters<
  PlatformConnectionRecord,
  PlatformConnectionQueryField
>;

export type PlatformConnectionOrderField = PlatformConnectionQueryField;
...
export type TenantStore = EntityStore<
  ...
  TenantOrderField
>;
export type PlatformConnectionStore = EntityStore<
  PlatformConnectionRecord,
...
export interface StorageStores {
  ...
  readonly platformConnections: PlatformConnectionStore;

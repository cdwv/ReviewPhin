...
export type FragmentFile<Registry extends FragmentRegistry> = keyof Registry &
  string;
export type TemplateId<Registry extends TemplateRegistry> = keyof Registry &
  string;
...
export type ParamlessFragmentFile<Registry extends FragmentRegistry> = {
  [K in FragmentFile<Registry>]: keyof FragmentParams<Registry, K> extends never
    ? K
    : never;

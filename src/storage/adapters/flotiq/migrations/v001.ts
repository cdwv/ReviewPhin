...
export const V001_CTDS = [
  ...
  generateCtdFromFieldsDescriptor("tenant", "Config/Tenant", {
    key: {
      ...
      label: "Key",
      required: true,
      helpText: "Unique key generated by the platform adapter.",
    },
...
type CtdDefinition = (typeof V001_CTDS)[number];

export default async function ensureV001CtdsExist(
  apiKey: string,
  logger?: Logger,
): Promise<void> {
  if (!apiKey) {
